...
class FinishActivity : AppCompatActivity() {
    ...
    private var user_data = FireStore("",0,0,0,0,0)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            .addOnSuccessListener { result ->
                for (document in result) { // 가져온 문서들이 result로 들어감
                    ...
                    user_data = FireStore(
                        ...
                        document["time"] as String, document["nextTime"] as String// count 추가 11.15
                    )
                    var saveP : Long =user_data.level//11.15 추가
        ...
        rtMainBtn.setOnClickListener {
            ...
            intentFinish.putExtra("gift",gift)
